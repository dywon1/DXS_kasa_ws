...
- **기여도**:
  ...
  - **올해**: 팀원이 추가되면서 인수인계와 함께 Python으로 작성한 코드를 C++로 변환하는 과정에서 원본 코드 제공과 지원을 통해 **50% 기여**하였습니다.
...
- **`lidar` 패키지 개발 (약 50% 기여)**
  ...
  - **올해**: 팀원이 추가되면서 인수인계와 함께 Python 코드를 C++로 변환하는 과정에서 원본 코드 제공과 지원을 통해 50% 기여하였습니다.
